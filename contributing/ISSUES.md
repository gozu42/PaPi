...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in PaPi, creating a new issue in the `Project-OWL/PaPi`
...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   `Project-OWL/PaPi` in a concrete and reviewable manner.

## Asking for General Help

The best place to ask for help is through the [PaPi Slack workspace][]. Open an
...
of the [PaPi Slack workspace][].

## Submitting a Bug Report

When opening a new issue in the `Project-OWL/PaPi` issue tracker, please provide as much
...
functional guidelines of the PaPi project.

[PaPi Slack workspace]: https://www.project-owl.com/slack
