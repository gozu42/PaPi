...
* [Reviewing pull requests](#reviewing-pull-requests)
  ...
  * [Accept that there are different opinions about what belongs in PaPi](#accept-that-there-are-different-opinions-about-what-belongs-in-PaPi)
...
More details to come on PaPi dependencies. In case of doubt, open an issue in the
[issue tracker](https://github.com/Project-OWL/PaPi/issues/) or engage on the
[PaPi Slack workspace][].
...
Fork the project [on GitHub](https://github.com/Project-OWL/PaPi) and clone your fork
locally.

```text
$ git clone git@github.com:username/PaPi.git
$ cd PaPi
$ git remote add upstream https://github.com/Project-OWL/PaPi.git
$ git fetch upstream
```
...
PaPi does not yet have a style guide. If you're interested in creating one, you're on the right page 😃
...
Fixes: https://github.com/Project-OWL/PaPi/issues/1337
Refs: http://eslint.org/docs/rules/space-in-parens.html
```

If you are new to contributing to PaPi, please try to do your best at
...
at least one PaPi Collaborators. After that, as long as there are no
...
All PaPi contributors who choose to review and provide feedback on pull
...
1. Does this change make sense for PaPi?
2. Does this change make PaPi better, even if only incrementally?
...
PaPi Collaborator landing the pull request but they can also be an
...
a particular change that makes PaPi better, but the individual might just
not want to have anything to do with PaPi ever again. The goal is not just
having good code.
...
Any PaPi core Collaborator (any GitHub user with commit rights in the
`Project-OWL/PaPi` repository) is authorized to approve any other contributor's
...
### Accept that there are different opinions about what belongs in PaPi

Opinions on this vary, even among the members of the Technical Steering
Committee.

One general rule of thumb is that if PaPi itself needs it (due to historic
or functional reasons), then it belongs in PaPi.
...
make PaPi better. These may or may not make sense to add, but as with all
...
PaPi has always optimized for speed of execution. If a particular change
can be shown to make some part of PaPi faster, it's quite likely to be
...
That said, performance is not the only factor to consider. PaPi also
...
to make sure that it works on the platforms that PaPi
...
[Code of Conduct]: https://github.com/Project-OWL/PaPi/blob/master/CONTRIBUTING.md#code-of-conduct
[Collaborator Guide]: https://github.com/Project-OWL/PaPi/blob/master/CONTRIBUTING.md
